...
# with command line options: step3 --conditions auto:phase1_2018_realistic -n 10 --era Run2_2018 --eventcontent RECOSIM,DQM --runUnscheduled -s RAW2DIGI:RawToDigi_pixelOnly,RECO:reconstruction_pixelTrackingOnly,VALIDATION:@pixelTrackingOnlyValidation,DQM:@pixelTrackingOnlyDQM --datatier GEN-SIM-RECO,DQMIO --geometry DB:Extended --no_exec --filein file:step2.root --fileout file:step3.root

from FWCore.ParameterSet.VarParsing import VarParsing
options = VarParsing ('python')
options.register('outputFile', 'TT_NTUPLE.root',
...
#
# Tracking ntuple customization
#
from TrackingNtuples.TrackingNtuples.customizeProcess import customize
customize(process, options.outputFile)
